...
// NOTE (2026-09-24): the dead OAuthCodexValidator object (standalone network token
// validation) was removed here. Sign-in intentionally skips it (OpenAiSignIn: demo exercises
// a real LLM call instead); account-id parsing lives in AuthStore/CodexHeaders.
